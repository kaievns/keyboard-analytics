...
console.log('');
console.log('Left shift pos:', LEFT_SHIFT_POS, diffPosition(LEFT_SHIFT_POS, LEFT_HAND_POS), distance(diffPosition(LEFT_SHIFT_POS, LEFT_HAND_POS)));
console.log('Right shift pos: ', RIGHT_SHIFT_POS, diffPosition(RIGHT_SHIFT_POS, RIGHT_HAND_POS), distance(diffPosition(RIGHT_SHIFT_POS, RIGHT_HAND_POS)));
